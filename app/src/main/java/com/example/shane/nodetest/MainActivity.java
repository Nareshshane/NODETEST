package com.example.shane.nodetest;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
      ...
      //  setSupportActionBar(toolbar);
        ...
        //make GET request
     // new GetDataTask().execute("http://172.16.5.223:1000/api/status");

        //make POST request
        new PostDataTask().execute("http://192.168.43.64:1000/api/status");
